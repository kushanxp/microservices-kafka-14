...
public class AccountsServiceImpl  implements IAccountsService {
    ...
    private void sendCommunication(Customer customer, Accounts accounts) {
        var accountMsgDto = new AccountMessageDto(accounts.getAccountNumber(), customer.getName(),
                customer.getEmail(), customer.getMobileNumber());
        logger.info("Sending communication request for the details {} ", accountMsgDto);
        var result = streamBridge.send("send-communication-out-0", accountMsgDto);
        logger.info("Data received from send-communication-out-0 {}", result);
    }
     ...
     * @return boolean indicating if the update of communication switch is successful or not
     */
    @Override
